...
SIMAPP = ./app
HTTPS_GIT := https://github.com/oracleNetworkProtocol/ethermint.git
...
PACKAGE_NAME:=github.com/oracleNetworkProtocol/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/oracleNetworkProtocol/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/oracleNetworkProtocol/ethermint/tests/importer
